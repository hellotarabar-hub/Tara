...
export default function WaitlistPopup({ isOpen, onClose }: WaitlistPopupProps) {
  ...
  // Prevent body scroll & add Mailchimp script when popup opens
  useEffect(() => {
    if (isOpen) {
      ...
      script.id = 'mcjs';
      script.src = 'https://chimpstatic.com/mcjs-connected/js/users/55288db69ea3107690efe06f6/0ac2b54b82c270ebfb6df3828.js';
      script.async = true;
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ fontSize: 'clamp(1.25rem, 2vw, 1.5rem)', fontWeight: 300, lineHeight: 1.4 }}
                    >
                      Welcome to TARA
                    </h3>
                    <p
                      className="text-neutral-600 tracking-wide leading-relaxed"
                      style={{ fontSize: 'clamp(1rem, 1.5vw, 1.125rem)', fontWeight: 300, lineHeight: 1.6 }}
                    >
                  ...
                  <>
                    ...
                    >
                      <h3
                        ...
                        style={{ fontSize: 'clamp(1.75rem, 4vw, 2rem)', fontWeight: 300, lineHeight: 1.2 }}
                      >
                        Join Our Waitlist
                      </h3>
                      <p
                    ...
                    >
                      <div>
                        <input
                          ...
                          required
                          className="w-full px-6 py-4 bg-neutral-50 border border-neutral-200 text-neutral-900 placeholder-neutral-400 outline-none focus:border-neutral-400 transition-all duration-300 tracking-wide"
                      ...
                      <button
                        type="submit"
                        className="w-full px-8 py-4 bg-neutral-900 text-white hover:bg-neutral-800 transition-all duration-300 flex items-center justify-center gap-3 group"
                        style={{ fontWeight: 400, letterSpacing: '0.1em', fontSize: 'clamp(0.875rem, 1vw, 0.875rem)' }}
                      >
                        JOIN WAITLIST
