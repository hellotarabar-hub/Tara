        ...
        >
          {submitted ? (
            ...
            >
              ...
              <p
                className="text-white/60 mt-2 text-sm tracking-wide"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between text-white/40 gap-4 text-xs tracking-wide">
            ...
            <div className="flex items-center gap-8">
              ...
              <button
                onClick={() =>
                  window.open('/privacy', '_blank', 'width=1000,height=800')
                }
                className="hover:text-white/80 transition-colors tracking-wide"
                style={{ letterSpacing: '0.1em' }}
              >
              ...
              <button
                onClick={() =>
                  window.open('/terms', '_blank', 'width=1000,height=800')
                }
                className="hover:text-white/80 transition-colors tracking-wide"
                style={{ letterSpacing: '0.1em' }}
              >
